...
<details><summary>Собственные оповещения</summary>
   ...
   ⚠️ Если в `message` будет содержаться SteamID - на сайте он автоматически заменится на имя игрока, и позволит открыть профиль (напр: "оповещение на 76561198121100397" заменится на "оповещение на **гнида**")
