...
<details><summary>Pro • Собственные оповещения</summary>
   ...
   `[CanBeNull] data` - любой JSON с нужной вам информацией (кол-во символов не более 512), который будет также отображаться на сайте\
