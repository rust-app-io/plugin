...
namespace Oxide.Plugins
{
  ...
  public class RustApp : RustPlugin
  {
    ...
    {
      _RustAppEngine.SignageWorker?.SignageCreate(new SignageUpdate(player, signage, url));
    }
    ...
    private void OnSignUpdated(Signage signage, BasePlayer player, int textureIndex = 0)
    {
      ...
      _RustAppEngine.SignageWorker?.SignageCreate(new SignageUpdate(player, signage));
    }
